...
import 'package:insighteye_app/components/vehicleinfocard.dart';
import 'package:insighteye_app/components/vusagehistorycard.dart';
...
class Vehicleportal extends StatefulWidget {
  String? orgId;
  Vehicleportal({Key? key, this.orgId}) : super(key: key);
    ...
    return Scaffold(
      ...
      floatingActionButton: InkWell(
        ...
        child: Container(
          ...
          height: s.width * 0.17,
          decoration:
              const BoxDecoration(shape: BoxShape.circle, color: bluebg),
          child: const Icon(
            Iconsax.add,
            color: white,
          ),
...
class NamedescDialog extends StatefulWidget {
  ...
  NamedescDialog({super.key, this.type, this.orgId});
