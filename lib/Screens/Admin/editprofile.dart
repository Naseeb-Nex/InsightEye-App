...
import 'package:insighteye_app/components/alertbox.dart';
...
class _EditprofileState extends State<Editprofile> {
  ...
  TextEditingController techuidController = TextEditingController();
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return CustomeAlertbx("Technician Profile Updation Completed!",
                  Colors.greenAccent, "Sucessfull", widget.techuid);
            });
        setState(() {
          _upload = false;
        });
