...
import 'package:insighteye_app/components/simplealertbox.dart';

class Resetpswdsrc extends StatefulWidget {
  String? uid;
  String? techuid;
  String? orgId;
  Resetpswdsrc({Key? key, this.uid, this.techuid, this.orgId}) : super(key: key);
...
class Incorrectalert extends StatelessWidget {
  ...
  final String? done;
  Incorrectalert(
      {Key? key, this.titles, required this.colorr, this.done, this.techuid})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Dialog(
